 ...
 *
 * @package   WC-Braintree/Gateway/MyBank
 * @author    WooCommerce
...
/**
 * Braintree MyBank Gateway Class.
 *
 * @since 3.9.0
 */
class WC_Gateway_Braintree_Mybank extends WC_Gateway_Braintree_Local_Payment {
	...
	protected function get_default_title() {
		...
		return __( 'MyBank', 'woocommerce-gateway-paypal-powered-by-braintree' );
	}
	...
	protected function get_default_description() {
		...
		return __( 'Pay securely using MyBank', 'woocommerce-gateway-paypal-powered-by-braintree' );
	}
	 ...
	 *
	 * Overrides parent to use a PNG icon.
	 *
	 * @since 3.9.0
	 *
	 * @return string
	...
	public function get_local_payment_icon_url(): string {
		...
		return wc_braintree()->get_plugin_url() . '/assets/images/' . $this->get_local_payment_type() . '.png';
	}
}
